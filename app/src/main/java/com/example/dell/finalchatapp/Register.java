...
public class Register extends AppCompatActivity {
    ...
    public String email,password,confirm_password,phone_number;
    private EditText inputEmail, inputPassword, inputConfirmPassword, inputPhoneNumber;
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                    ...
                                    else
                                    {
                                        ...
                                        Registrations registration = new Registrations(email,phone_number);
